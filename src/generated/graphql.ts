...
export type SubGameSession = {
  ...
  alreadyPlayedUsers: Array<Player>;
  activePlayers: Array<Player>;
  onlyAllowSubs: Scalars['Boolean'];
};

export type StartSubGameSessionInput = {
  ownerId: Scalars['ID'];
...
export type StartSubGameSessionPayload = {
  __typename?: 'StartSubGameSessionPayload';
  subGameSession: SubGameSession;
};

export type GetSubGameSessionInput = {
  username: Scalars['ID'];
};

export type GetSubGameSessionPayload = {
...
export type QueryGetSubGameSessionArgs = {
...
export type MutationStartSubGameSessionArgs = {
