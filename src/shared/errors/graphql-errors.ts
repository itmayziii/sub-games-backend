...
/**
 * When a user does not have the required permission to perform the action.
 */
export class GraphQLForbiddenLackingPermissionError extends ForbiddenError {
  constructor (permission: string) {
    super(`Permission "${permission}" is required to perform this action.`)
  }
}
